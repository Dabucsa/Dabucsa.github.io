  ...
  return (
    <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#dc2626]/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Location badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#141414] border border-[#262626] rounded-full mb-8">
            <MapPin size={16} className="text-[#dc2626]" />
            <span className="text-sm text-gray-400">
              Av. O&apos;Higgins 717, Pucon
            </span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-10">
            ...
            descubre por que somos el dojo preferido del sur de Chile.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contacto"
              className="group px-8 py-4 bg-[#dc2626] hover:bg-[#991b1b] text-white font-bold uppercase tracking-wider rounded-lg transition-all duration-300 hover:shadow-xl hover:shadow-red-500/30 flex items-center gap-2"
            >
        ...
        >
          <div className="relative rounded-2xl overflow-hidden border border-[#262626]">
            ...
            />
            {/* Overlay card */}
            <div className="absolute bottom-6 left-6 bg-[#141414]/95 backdrop-blur-sm border border-[#262626] rounded-xl p-4 max-w-xs">
              <h3 className="text-white font-bold mb-1">Dojo Zen Pucon</h3>
              <p className="text-gray-400 text-sm">
                Av. O&apos;Higgins 717, Local 3
                <br />
                Segundo Piso, Pucon
              </p>
            </div>
